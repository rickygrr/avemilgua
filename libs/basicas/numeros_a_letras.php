...
/*!
  ...
  - Modificado por Perry Daniels para uso general / 20/10/2012
*/
//echo "-Numeros a letras";

function qnum2letras($numero, $moneda = "quetzales", $moneda1 = "quetzal"){
  if ($numero==1) {
     return "Un "." ".$moneda1;
  } else {
     $decimal = 0;
     ...
     return num2letras($numero)." ".$moneda." con ".$decimal."/100";
  } 
...
echo "<strong>$numero</strong> se dice: <strong>".num2letras($numero)."</strong><br>";
 ...
 $numero = 12560.08;
list($entero,$decimal)=explode(".",$numero);
echo "$numero se dice: “.num2letras($numero).” con “.$decimal.”/100″.”“;
*/
?>
