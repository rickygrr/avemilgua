...
--
-- Servidor: localhost
-- Tiempo de generación: 04-06-2015 a las 03:55:57
...
--
-- Base de datos: `insayd_apolo`
--

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `ap_bitacora`
--

CREATE TABLE IF NOT EXISTS `ap_bitacora` (
...
--
-- Volcado de datos para la tabla `ap_bitacora`
--
...
--
-- Estructura de tabla para la tabla `ap_catalogos`
--

CREATE TABLE IF NOT EXISTS `ap_catalogos` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `ap_catalogos`
--
...
--
-- Estructura de tabla para la tabla `ap_eventcal`
--

CREATE TABLE IF NOT EXISTS `ap_eventcal` (
...
--
-- Estructura de tabla para la tabla `ap_instituciones`
--

CREATE TABLE IF NOT EXISTS `ap_instituciones` (
...
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='Distintas instituciones que interactuan con el sisitema';

--
-- Volcado de datos para la tabla `ap_instituciones`
--
...
--
-- Estructura de tabla para la tabla `ap_municipios`
--

CREATE TABLE IF NOT EXISTS `ap_municipios` (
`id` int(6) NOT NULL,
  `nombre` varchar(100) COLLATE utf8_bin NOT NULL,
  `departamento_id` int(3) NOT NULL,
  `departamento` varchar(100) COLLATE utf8_bin NOT NULL
) ENGINE=MyISAM AUTO_INCREMENT=2218 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

--
-- Volcado de datos para la tabla `ap_municipios`
--
...
CREATE TABLE IF NOT EXISTS `ap_perfil` (
`id` int(4) NOT NULL,
...
) ENGINE=MyISAM AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='Información para el cierre mensual de condominio';

--
-- Volcado de datos para la tabla `ap_perfil`
--
...
--
-- Estructura de tabla para la tabla `ap_seccion`
--

CREATE TABLE IF NOT EXISTS `ap_seccion` (
`id` int(4) NOT NULL,
...
--
-- Volcado de datos para la tabla `ap_seccion`
--
...
--
-- Estructura de tabla para la tabla `ap_tipo_catalogos`
--

CREATE TABLE IF NOT EXISTS `ap_tipo_catalogos` (
...
--
-- Volcado de datos para la tabla `ap_tipo_catalogos`
--
...
--
-- Estructura de tabla para la tabla `ap_unidad`
--

CREATE TABLE IF NOT EXISTS `ap_unidad` (
`id` int(4) NOT NULL,
  `institucion` int(4) NOT NULL,
  `nombre` varchar(45) COLLATE utf8_bin NOT NULL,
  `nombre_corto` varchar(15) COLLATE utf8_bin DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `ap_unidad`
--
...
--
-- Volcado de datos para la tabla `ap_usuarios`
--
...
--
-- Estructura de tabla para la tabla `ig_agua`
--

CREATE TABLE IF NOT EXISTS `ig_agua` (
...
--
-- Estructura de tabla para la tabla `ig_areas`
--

CREATE TABLE IF NOT EXISTS `ig_areas` (
`id` int(11) NOT NULL,
  `institucion` int(4) NOT NULL,
  `condominio` int(4) NOT NULL,
...
--
-- Volcado de datos para la tabla `ig_areas`
--
...
--
-- Estructura de tabla para la tabla `ig_bancos`
--

CREATE TABLE IF NOT EXISTS `ig_bancos` (
`id` int(4) NOT NULL,
...
--
-- Volcado de datos para la tabla `ig_bancos`
--
...
--
-- Estructura de tabla para la tabla `ig_casas`
--

CREATE TABLE IF NOT EXISTS `ig_casas` (
...
--
-- Volcado de datos para la tabla `ig_casas`
--
...
--
-- Estructura de tabla para la tabla `ig_conveniospago`
--

CREATE TABLE IF NOT EXISTS `ig_conveniospago` (
`id` bigint(20) NOT NULL,
  `codigo` varchar(20) COLLATE utf8_bin NOT NULL,
...
--
-- Estructura de tabla para la tabla `ig_eventcal`
--

CREATE TABLE IF NOT EXISTS `ig_eventcal` (
`id` bigint(20) unsigned NOT NULL,
  `codigo` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `condominio` int(4) NOT NULL,
  `institucion` int(4) NOT NULL,
  ...
  `observaciones` text COLLATE utf8_bin,
  `estatus` int(4) NOT NULL DEFAULT '1'
) ENGINE=MyISAM AUTO_INCREMENT=34 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='Eventos de Calendario';

--
-- Volcado de datos para la tabla `ig_eventcal`
--
...
--
-- Estructura de tabla para la tabla `ig_gasto`
--

CREATE TABLE IF NOT EXISTS `ig_gasto` (
`id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `ig_gasto`
--
...
--
-- Estructura de tabla para la tabla `ig_movimientos`
--

CREATE TABLE IF NOT EXISTS `ig_movimientos` (
`id` bigint(20) NOT NULL,
...
--
-- Volcado de datos para la tabla `ig_movimientos`
--
...
--
-- Estructura de tabla para la tabla `ig_ordenes_trabajo`
--

CREATE TABLE IF NOT EXISTS `ig_ordenes_trabajo` (
`id` bigint(20) NOT NULL,
  `institucion` int(4) NOT NULL,
  `condominio` int(4) NOT NULL,
  `codigo` varchar(20) COLLATE utf8_bin NOT NULL,
...
--
-- Estructura de tabla para la tabla `ig_pagos_banco`
--

CREATE TABLE IF NOT EXISTS `ig_pagos_banco` (
...
--
-- Estructura de tabla para la tabla `ig_pedido`
--

CREATE TABLE IF NOT EXISTS `ig_pedido` (
`id` bigint(20) NOT NULL,
...
--
-- Volcado de datos para la tabla `ig_pedido`
--
...
--
-- Estructura de tabla para la tabla `ig_perservicio`
--

CREATE TABLE IF NOT EXISTS `ig_perservicio` (
`id` bigint(20) NOT NULL,
...
--
-- Estructura de tabla para la tabla `ig_productos`
--

CREATE TABLE IF NOT EXISTS `ig_productos` (
`id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `ig_productos`
--
...
--
-- Estructura de tabla para la tabla `ig_prorroga_corte`
--

CREATE TABLE IF NOT EXISTS `ig_prorroga_corte` (
`id` bigint(20) NOT NULL,
  `codigo` varchar(20) COLLATE utf8_bin NOT NULL,
  `fecha` date NOT NULL,
...
--
-- Estructura de tabla para la tabla `ig_proveedor`
--

CREATE TABLE IF NOT EXISTS `ig_proveedor` (
`id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `ig_proveedor`
--
...
--
-- Estructura de tabla para la tabla `ig_tarjetas_vehiculo`
--

CREATE TABLE IF NOT EXISTS `ig_tarjetas_vehiculo` (
`id` bigint(20) NOT NULL,
  `codigo` varchar(20) COLLATE utf8_bin NOT NULL,
  `institucion` int(4) NOT NULL,
  `condominio` int(4) NOT NULL,
...
--
CREATE TABLE IF NOT EXISTS `v_ingresos` (
`pedido` bigint(20)
,`abono` decimal(11,2)
,`fecha` datetime
,`condominio` int(4)
...
CREATE ALGORITHM=UNDEFINED DEFINER=`insayd`@`localhost` SQL SECURITY DEFINER VIEW `v_ingresos` AS select `m`.`pedido` AS `pedido`,`m`.`abono` AS `abono`,`m`.`fecha` AS `fecha`,`m`.`condominio` AS `condominio`,`m`.`factura` AS `factura`,`p`.`id` AS `id`,`p`.`tipo` AS `tipo`,(select `c`.`comodin` from (`ap_catalogos` `c` join `ig_productos` `pr`) where ((`c`.`tipo_catalogo` = 10) and (`c`.`id` = `pr`.`tipo`) and (`pr`.`id` = `p`.`tipo`))) AS `producto`,`p`.`moneda` AS `moneda`,`p`.`codigo` AS `codigo`,(`p`.`cantidad` * `p`.`precio`) AS `valor` from (`ig_movimientos` `m` join `ig_pedido` `p`) where (`m`.`factura` = `p`.`referencia`);
...
--
-- Indices de la tabla `ap_bitacora`
--
ALTER TABLE `ap_bitacora`
 ADD PRIMARY KEY (`fecha`), ADD KEY `fk_bitacora_institucion1_idx` (`institucion`);

--
-- Indices de la tabla `ap_catalogos`
--
ALTER TABLE `ap_catalogos`
 ADD PRIMARY KEY (`id`,`tipo_catalogo`,`institucion`), ADD KEY `fk_ins_catalogos_tipo_catalogos1_idx` (`tipo_catalogo`), ADD KEY `fk_ins_catalogos_institucion1_idx` (`institucion`);

--
-- Indices de la tabla `ap_eventcal`
--
ALTER TABLE `ap_eventcal`
 ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `ap_instituciones`
--
ALTER TABLE `ap_instituciones`
 ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `ap_municipios`
--
...
--
-- Indices de la tabla `ap_seccion`
--
ALTER TABLE `ap_seccion`
 ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `ap_tipo_catalogos`
--
ALTER TABLE `ap_tipo_catalogos`
 ADD PRIMARY KEY (`idtipo`);

--
-- Indices de la tabla `ap_unidad`
--
...
--
-- Indices de la tabla `ig_agua`
--
ALTER TABLE `ig_agua`
 ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `ig_areas`
--
ALTER TABLE `ig_areas`
 ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `ig_bancos`
--
ALTER TABLE `ig_bancos`
 ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `ig_casas`
--
ALTER TABLE `ig_casas`
 ADD PRIMARY KEY (`codigo`,`condominio`,`institucion`);

--
-- Indices de la tabla `ig_conveniospago`
--
ALTER TABLE `ig_conveniospago`
 ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `ig_eventcal`
--
ALTER TABLE `ig_eventcal`
 ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `ig_gasto`
--
ALTER TABLE `ig_gasto`
 ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `ig_movimientos`
--
ALTER TABLE `ig_movimientos`
 ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `ig_ordenes_trabajo`
--
ALTER TABLE `ig_ordenes_trabajo`
 ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `ig_pagos_banco`
--
ALTER TABLE `ig_pagos_banco`
 ADD PRIMARY KEY (`correlativo`);

--
-- Indices de la tabla `ig_pedido`
--
ALTER TABLE `ig_pedido`
 ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `ig_perservicio`
--
ALTER TABLE `ig_perservicio`
 ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `ig_productos`
--
ALTER TABLE `ig_productos`
 ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `ig_prorroga_corte`
--
ALTER TABLE `ig_prorroga_corte`
 ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `ig_proveedor`
--
ALTER TABLE `ig_proveedor`
 ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `ig_tarjetas_vehiculo`
--
...
--
-- AUTO_INCREMENT de la tabla `ap_eventcal`
--
ALTER TABLE `ap_eventcal`
MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `ap_instituciones`
--
ALTER TABLE `ap_instituciones`
MODIFY `id` int(4) NOT NULL AUTO_INCREMENT COMMENT 'ID de entidad',AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT de la tabla `ap_municipios`
--
ALTER TABLE `ap_municipios`
...
--
-- AUTO_INCREMENT de la tabla `ap_seccion`
--
ALTER TABLE `ap_seccion`
MODIFY `id` int(4) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT de la tabla `ap_tipo_catalogos`
--
ALTER TABLE `ap_tipo_catalogos`
MODIFY `idtipo` tinyint(4) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=37;
--
-- AUTO_INCREMENT de la tabla `ap_unidad`
--
ALTER TABLE `ap_unidad`
...
--
-- AUTO_INCREMENT de la tabla `ig_agua`
--
ALTER TABLE `ig_agua`
MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `ig_areas`
--
ALTER TABLE `ig_areas`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=29;
--
-- AUTO_INCREMENT de la tabla `ig_bancos`
--
ALTER TABLE `ig_bancos`
MODIFY `id` int(4) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `ig_conveniospago`
--
ALTER TABLE `ig_conveniospago`
MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `ig_eventcal`
--
ALTER TABLE `ig_eventcal`
MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=34;
--
-- AUTO_INCREMENT de la tabla `ig_gasto`
--
ALTER TABLE `ig_gasto`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT de la tabla `ig_movimientos`
--
ALTER TABLE `ig_movimientos`
MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=19;
--
-- AUTO_INCREMENT de la tabla `ig_ordenes_trabajo`
--
ALTER TABLE `ig_ordenes_trabajo`
MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `ig_pagos_banco`
--
ALTER TABLE `ig_pagos_banco`
MODIFY `correlativo` bigint(20) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `ig_pedido`
--
ALTER TABLE `ig_pedido`
MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=134;
--
-- AUTO_INCREMENT de la tabla `ig_perservicio`
--
ALTER TABLE `ig_perservicio`
MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `ig_productos`
--
ALTER TABLE `ig_productos`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=119;
--
-- AUTO_INCREMENT de la tabla `ig_prorroga_corte`
--
ALTER TABLE `ig_prorroga_corte`
MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `ig_proveedor`
--
ALTER TABLE `ig_proveedor`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT de la tabla `ig_tarjetas_vehiculo`
--
ALTER TABLE `ig_tarjetas_vehiculo`
MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;
