...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><i class="fa fa-building-o"></i> Administración de Secciones</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
...
<!-- BOX TABS (Peledahe) -->
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-primary">
                    ...
                    <input class="text" name="p" type="hidden" value="sistema/secciones_gestion.php"/>
    ...
    ?>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select id="unidad" class="form-control col-md-12" name="unidad" >
                                <?php
                                    $sql2="SELECT  id, nombre
                                            FROM ap_unidad
                                            WHERE 1=1
                                ...
                                <?php 
                                    while($row2=mysql_fetch_assoc($resp2)){
                                        print '<option value="'.$row2['id'].'" ';
                                        if ($unidad == $row2['id']) { print ' selected="selected" '; };
                                        print ' >'.utf8_encode($row2['nombre']).'</option>';
                                    };
                                ?>
                            </select>
