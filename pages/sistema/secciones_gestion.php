<?php
  ...
  if ($id || $nombre) {
	switch ($btn) {
	        ...
	        break;
            case "Borrar":
	        $sql1 = "DELETE FROM ap_seccion WHERE id = '".$id."'";
	        break;
    	} // End switch
        ...
        <div class="row">
            ...
            <div class="col-md-12 text-center">
                <div class="">
                    ...
                    <div class="btn-group">
                            <a href="index.php?p=sistema/secciones_list.php&unidad=<?php echo $unidad; ?>" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Listado de Secciones</a>
                            <a href="index.php?p=sistema/unidades_list.php" class="btn btn-danger"><i class="fa fa-arrow-up"></i> Listado de Unidades</a>  
