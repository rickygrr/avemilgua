...
?>
                    ...
                    <div class="form-group" id="ealarmas">
                        <label for="alarmas" class="col-sm-2 control-label">Alarmas</label>
                        <div class="col-sm-4">
                            <input type="number" class="form-control" id="alarmas" placeholder="alarmas" name="alarmas" value="<?php echo utf8_encode($alarmas); ?>" required="">
                            <input type="text" class="form-control" id="palarmas" placeholder="palarmas" name="palarmas" value="<?php echo utf8_encode($palarmas); ?>"  disabled="">
                        </div>
                        <label for="dif_alarmas" class="col-sm-2 control-label">Dif Alarmas</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="dif_alarmas1" placeholder="dif_alarmas" name="dif_alarmas1" value="<?php echo utf8_encode($dif_alarmas); ?>" disabled="">
                            <input type="text" class="form-control" id="dif_alarmas" placeholder="dif_alarmas" name="dif_alarmas" value="<?php echo utf8_encode($dif_alarmas); ?>"  disabled="">
                        </div>
                    </div>
                    <div class="form-group" id="eeventos">
                        <label for="eventos" class="col-sm-2 control-label">Eventos</label>
                        <div class="col-sm-4">
                            <input type="number" class="form-control" id="eventos" placeholder="eventos" name="eventos" value="<?php echo utf8_encode($eventos); ?>" required="">
                            <input type="text" class="form-control" id="peventos" placeholder="peventos" name="peventos" value="<?php echo utf8_encode($peventos); ?>"  disabled="">
                        </div>
                        <label for="dif_eventos" class="col-sm-2 control-label">Dif Eventos</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="dif_eventos1" placeholder="dif_eventos" name="dif_eventos1" value="<?php echo utf8_encode($dif_eventos); ?>" disabled="">
                            <input type="text" class="form-control" id="dif_eventos" placeholder="dif_eventos" name="dif_eventos" value="<?php echo utf8_encode($dif_eventos); ?>"  disabled="">
                        </div>
                    </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $("#eventos").change(function(){
           ...
           function(data){
               // asigna el valor
               $("#dif_eventos").val(data);
               $("#dif_eventos1").val(data);
               // reemplaza el objeto completo
               //$("#fecha_cobro").replaceWith(data);

               if ($("#dif_eventos").val() > $("#peventos").val()) {
